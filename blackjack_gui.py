...
def help():
	messagebox.showinfo("Help", "Shuffle: Begin a new game\n"
		...
		"Blackjack originates in 1960s France, called Vingt-et-Un (French for 21). Its goal is in the name: Score closest to 21 without going over.\n\n"
...
player_label_3 = tk.Label(player_frame, text='', bg=back_color)
player_label_3.grid(row=1, column=2, padx=10)

player_label_4 = tk.Label(player_frame, text='', bg=back_color)
player_label_4.grid(row=1, column=3, padx=10)

player_label_5 = tk.Label(player_frame, text='', bg=back_color)
player_label_5.grid(row=1, column=4, padx=10)

dealer_label_1 = tk.Label(dealer_frame, text='', bg=back_color)
dealer_label_1.grid(row=1, column=0, padx=10)

dealer_label_2 = tk.Label(dealer_frame, text='', bg=back_color)
dealer_label_2.grid(row=1, column=1, padx=10)

dealer_label_3 = tk.Label(dealer_frame, text='', bg=back_color)
dealer_label_3.grid(row=1, column=2, padx=10)

dealer_label_4 = tk.Label(dealer_frame, text='', bg=back_color)
dealer_label_4.grid(row=1, column=3, padx=10)

dealer_label_5 = tk.Label(dealer_frame, text='', bg=back_color)
